...
CATEGORY_DELIVERY = {
    "Обувь/Куртки": 1600,
    "Джинсы/Кофты": 1150,
    "Штаны/Юбки/Платья": 1000,
    "Футболки/Аксессуары": 900,
    "Часы/Украшения": 1200,
    "Сумки/Рюкзаки": 1200,
    "Техника/Другое": 0
}
...
async def calc_price_final(message: types.Message, state: FSMContext):
    try:
        ...
        await message.answer(
            ...
            f"📦  <b>Дополнительно</b>: после прибытия заказа во Владивосток применяются тарифы CDEK/Почты России для внутренней доставки — <b>эта сумма оплачивается отдельно</b>🫶🏼\n\n"
